  ...
  return [
    {
      ...
      value: currentCount,
      recommended: true,
      description: 'Best first pass; prioritizes larger signals and keeps coverage across issue types.',
      rationale: 'best first pass; prioritizes larger signals and keeps coverage across issue types',
    },
    {
      label: `Investigate all ${total}`,
      value: 'all',
      recommended: false,
      description: 'Full audit of every signal that met the threshold; follow-up metrics can still remove mismatches before source investigation.',
      rationale: 'full audit of every signal that met the threshold; follow-up metrics can still remove mismatches before source investigation',
    },
    {
